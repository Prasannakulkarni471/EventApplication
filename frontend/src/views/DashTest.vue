                    ...
                    <v-row>
                      <v-col cols="12" md="8">
                        <v-card-text class="mt-12">
                          <h1 class="text-center display-2 teal--text text--accent-3">Sign in to SymBooth</h1>
                        ...
                        <div class="text-center mt-3">
                          <router-link :to="{ path: '/EventsPage' }"><v-btn rounded color="teal accent-3" dark>SIGN
                    ...
                    <v-row class="fill-height">
                      ...
                      <v-col cols="12" md="8">
                        <v-card-text class="mt-12">
                          ...
                          <h4 class="text-center mt-4">Ensure your email for registration</h4>
                          <v-form>
                            <v-text-field label="Name" name="Name" v-model="username" prepend-icon="person" type="text"
                              color="teal accent-3" />
                            <v-text-field label="Email" name="Email" v-model="email" prepend-icon="email" type="email"
                              color="teal accent-3" />
